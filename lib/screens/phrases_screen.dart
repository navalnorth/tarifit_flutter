...
class _PhrasesScreenState extends State<PhrasesScreen> {
  ...
  bool _adShown = false; // ✅ Pour éviter de réafficher la native ad plusieurs fois
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Liste des phrases")),
      body: SafeArea(
        child: Column(
          children: [
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: phrases.map((phrase) {
                    return MotCard(
                      motFrancais: phrase["phraseFrancais"],
                      motRif: phrase["phraseRif"],
